                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="article_description pt-4 pb-5 px-2">
                                ...
                                <h1 class="h2 text-center pb-2">{{$subcategory->name}}</h1>
                                <hr class="mt-0 mb-4">
                                    ...
                                    <div class="single_category_box">
                                        <div class="list-group rounded-0">
                                                ...
                                                @foreach($subcategory->knowledge as $knowledge)
                                                    <a href="{{route('help-single-knowledge',[$subcategory->category->id,$knowledge->id])}}" class="rounded-0 single_category_box_item text-muted">
