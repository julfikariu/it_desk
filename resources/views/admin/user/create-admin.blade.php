    ...
    <div class="row">
        <div class="col-12">
            <div class="card card-dark bg-dark">
                ...
                <div class="card-body ">
                    <form action="{{route('admin.store-create-admin')}}" method="POST">
                        @csrf
                        ...
                        <div class="wizard-action text-left">
                            <button class="btn btn-wave-light btn-danger btn-lg" type="submit">Create Admin</button>
                        </div>
                    </form>
