            ...
            <div class="card-header d-block">
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12 text-right">
                        <a href="{{route('admin.create-category-form')}}" class="btn btn-success"> {{__('Add New Category')}}</a>
                    </div>
                </div>
            </div>
                ...
                <div class="table-responsive style-scroll">
                    <table id="example" class="table table-striped table-bordered miw-500" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{route('admin.create-category-form', $data->id)}}" class="btn btn-info  btn-circle">
                                    <i class="material-icons">visibility</i>
                                </a>
                                <a href="{{route('admin.delete-category', $data->id)}}" title="Delete"
