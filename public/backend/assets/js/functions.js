...
$(document).ready(function () {
    ...
    $('#option-pageLayout , #option-pageLayout-navbar, #option-pageLayout-sidebar').change(function () {
    ...
    $("input[type='radio'][name='enable_google_recaptcha']").on('change', function(){

        var value = $(this).val();

        if(value == 'no')
            $('#google_recaptcha').fadeOut('slow');
        else
            $('#google_recaptcha').fadeIn('slow');

    });
    $("input[type='radio'][name='enable_google_login']").on('change', function(){

        var value = $(this).val();

        if(value == 'no')
            $('#google_login').fadeOut('slow');
        else
            $('#google_login').fadeIn('slow');

    });
    $("input[type='radio'][name='enable_fb_login']").on('change', function(){

        var value = $(this).val();

        if(value == 'no')
            $('#fb_login').fadeOut('slow');
        else
            $('#fb_login').fadeIn('slow');
