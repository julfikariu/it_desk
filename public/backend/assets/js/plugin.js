...
(function () {
    ...
    //-----------------------------------------------------------------------------------------------
     ...
     - INIT : $('selector').prototipoStartTime();
     
     ---------------------------------------------------------------------------------------------- */

    $.fn.prototipoStartTime = function() {
     ...
     - INIT : $('selector').prototipoCircleTime();
     
     ---------------------------------------------------------------------------------------------- */

    $.fn.prototipoCircleTime = function() {
        var parent = $(this);
     ...
     - INIT : $('selector').prototipoTimePicker();
     
     ---------------------------------------------------------------------------------------------- */

    $.fn.prototipoTimePicker = function() {

        var parent = $(this);

        var construct = function(){

            var $timePicker_container = $("<div class='prototipoTimePicker-container'></div>");
            var $timePicker_time = $("<div class='prototipoTimePicker-time'></div>");

            var $timePicker_hour = $("<div class='prototipoTimePicker-hour'><span class='value'>10</span> <span class='up fa fa-chevron-up'></span>  <span class='down fa fa-chevron-down'></span></div>");
            var $timePicker_minute = $("<div class='prototipoTimePicker-minute'><span class='value'>00</span> <span class='up fa fa-chevron-up'></span>  <span class='down fa fa-chevron-down'></span></div>");
            var $timePicker_format = $("<div class='prototipoTimePicker-format'><span class='value'>AM</span> <span class='change fa fa-chevron-down'></span></div>");
            var $timePicker_divider = $("<div class='prototipoTimePicker-divider'><span>:</span></div>");
            var $timePicker_input = $("<input type='hidden' value='10:00 AM' class='prototipoTimePicker-input'/>");
        ...
        var triggerAction = function () {
            ...
            $(parent).on('click', '.prototipoTimePicker-hour span', function(){
                var $valueNode = parent.find(".prototipoTimePicker-hour .value");
                var $inputNode = parent.find(".prototipoTimePicker-input");
                var value;
                if($(this).hasClass("up")){
            ...
            $(parent).on('click', '.prototipoTimePicker-minute span', function(){
                var $valueNode = parent.find(".prototipoTimePicker-minute .value");
                var $inputNode = parent.find(".prototipoTimePicker-input");
                var value;
                if($(this).hasClass("up")){
                    value = parseInt($valueNode.text()) + 1;
            ...
            $(parent).on('click', '.prototipoTimePicker-format .change', function(){
                var $valueNode = parent.find(".prototipoTimePicker-format .value");
                var $inputNode = parent.find(".prototipoTimePicker-input");
    ...
    - INIT : $('selector').prototipoCalendar(params);
    ...
    $.fn.prototipoCalendar = function(para) {
        ...
        var construct = function(){
            ...
            //HEADER ----------------------------------------------------------------------------------
            var header = $("<div class='prototipoCalendar-header'></div>");
            ...
            // TABLE ----------------------------------------------------------------------------------
            var table = $("<table class='prototipoCalendar-table'></table>");
            ...
            var list = $("<ul class='prototipoCalendar-list' style='background-color: "+backgroundColor+"'></ul>");
            ...
            var add = " <div class='prototipoCalendar-add' style='background-color: "+backgroundColor+"'> <div id='"+idTimerPicker+"'></div> <textarea class='note-content' placeholder='Write something...'></textarea> <div class='prototipoCalendar-actions'> <span class='action action-add-close material-icons'>close</span> <span class='action action-add-confirm material-icons'>add</span> </div> </div>";

            // FOOTER ---------------------------------------------------------------------------------
            var footer = $("<div class='prototipoCalendar-footer'></div>");
            ...
            parent.html("");
            parent.addClass("prototipoCalendar");
            parent.addClass("prototipoCalendar-"+theme);
            ...
            $("#"+idTimerPicker).prototipoTimePicker();
        };
        ...
        var triggerAction = function () {
            ...
            $(parent).on('click', '.action-day', function() {
                ...
                $(parent).find(".prototipoCalendar-add").slideToggle();
            ...
            $(parent).on('click', '.action-events', function() {
                $(parent).find(".prototipoCalendar-list").slideToggle();
            });

            $(parent).on('click', '.action-add-confirm', function() {
                var currentTime = $(parent).find(".prototipoTimePicker-input").val();
