...
var ui = {
    ...
    button: function ($node, options) {
        return renderer.create('<button type="button" class="note-btn btn btn-white btn-sm" tabindex="-1">', function ($node, options) {
...
var Context = /** @class */ (function () {
    ...
    /**
     * create pageLayout and initialize modules and other resources
     */
    ...
    /**
     * destroy modules and other resources and remove pageLayout
     */
